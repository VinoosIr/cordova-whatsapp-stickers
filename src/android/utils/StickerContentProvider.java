...
public class StickerContentProvider extends ContentProvider {
    ...
    private static final String CONTENT_FILE_NAME = "www/contents.json";
    public static final String CONTENT_PROVIDER_AUTHORITY = "miladesign.cordova.wastickers.utils.stickercontentprovider";

    public static final Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(CONTENT_PROVIDER_AUTHORITY).appendPath(StickerContentProvider.METADATA).build();
    ...
    private AssetFileDescriptor fetchFile(@NonNull Uri uri, @NonNull AssetManager am, @NonNull String fileName, @NonNull String identifier) {
        try {
            return am.openFd("www/" + identifier + "/" + fileName);
        } catch (IOException e) {
